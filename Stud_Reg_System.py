...
def Clear():
    ...
    img1=PhotoImage(file='Images/upload-image.png')
...
def Save():
    ...
    if N1 == "" or C1 == "Select Class" or D2 == "" or Re1 == "" or S1 == "" or fathername == "" or mothername == "" or F1 == "":
...
Label(root, text="Email:bencyb29@gmail.com", width=10, height=3, bg="#f0687c", anchor='e').pack(side="top", fill="x")
Label(root, text="REGISTRATION", width=15, height=2, bg="#c36464", fg="#fff", font='arial 20 bold').pack(side="top", fill="x")

Search = StringVar()
Entry(root, textvariable=Search, width=15, bd=2, font="arial 20").place(x=820, y=70)
imageicon3 = PhotoImage(file="Images/search.png")
Srch = Button(root, text="Search", compound="left", image=imageicon3, width=100, height=35, bg="#68ddfa", font="arial 13 bold",command=search)
Srch.place(x=1060, y=66)

imageicon4 = PhotoImage(file="Images/Layer_4.png")
Update_button = Button(root,text="Update", image=imageicon4, bg="#c36464", width=100, height=50,command=Update)
...
DOB = StringVar()
dob_entry = Entry(obj, textvariable=DOB, width=20, font="arial 13")
...
Label(obj2,text="Mothers's Name:",font="arial 13",bg=framebg,fg=framefg).place(x=500,y=50)
...
img = Image.open("Images/upload-image.png")
